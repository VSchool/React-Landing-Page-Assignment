This project was created for VSchool.
###React: Create home page.

#####The purpose of this exercise is to create three basic components, a header, body, and footer, and incorporate them into a landing page.
